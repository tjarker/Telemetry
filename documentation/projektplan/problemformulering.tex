...
\begin{ganttchart}{1}{20}
    \gantttitle{Roast Telemetry}{20} \\
    \gantttitlelist{9,10,11,12,14,15,16,17,18,19}{2} \\
    \ganttbar{Møder}{1}{20} \\
    \ganttbar{Rap. skrivning}{7}{8}
    \ganttbar{}{18}{20} \ganttnewline
    % Hvordan fjernes det mærkelige link på figur?
    \ganttgroup{Solar Car Unit}{1}{20} \\
    \ganttbar{Design af telemetrimodul}{1}{2} \\
    \ganttlinkedbar{Prototype udvikling}{3}{7} \ganttnewline
    \ganttmilestone{Krav opfyldt}{7} 
    \ganttlink{elem5}{elem6}\ganttnewline
    \ganttbar{Produkt udvikling}{8}{12}
    \ganttlink{elem6}{elem7}\\
    \ganttbar{GUI}{8}{12}
    \ganttlink{elem6}{elem8}
    \ganttlink{elem2}{elem3}\\
    \ganttgroup{Support Vehicle Unit}{1}{20} \\
\end{ganttchart}
