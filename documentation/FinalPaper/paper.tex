...
\begin{figure}[h]
    \centering
    \includegraphics[trim={0 2cm 0 0 },clip]{documentation/images/EnhancedShockburst.pdf}
...
As a specific RTOS, we chose ChibiOS \cite{chibios}, since it is supported both the Teensy 3.6 and 4.0 and since it attempts to keep the memory footprint of the real time kernel as small as possible.
...
%Finally, we were able to test all three modules 
